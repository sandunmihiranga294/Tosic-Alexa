...
const axios = require('axios');
  ...
  Alexa.addCMD({pattern: 'love', fromMe: false,desc:' සමූහයක අයෙකුට ආදරේ ප්‍රකාශ කරන්න 🤗' }, (async (message, match) => {
...
Alexa.addCMD({pattern: 'infolove', fromMe: false}, (async (message, match) => {
