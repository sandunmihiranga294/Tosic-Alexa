...
Asena.addCommand({pattern: 'bts ?(.*)', fromMe: sourav, desc: 'Sends random BTS wallpaper' , dontAddCommandList: true }, async (message, match) => {
...
Asena.addCommand({pattern: 'bpink ?(.*)', fromMe: sourav, desc: 'Sends random Blackpink wallpaper' , dontAddCommandList: true }, async (message, match) => {
...
Asena.addCommand({pattern: 'xxx ?(.*)', fromMe: sourav, desc: 'Sends random Xxxtentacion wallpaper' , dontAddCommandList: true }, async (message, match) => {
...
Asena.addCommand({pattern: 'wallpaper ?(.*)', fromMe: sourav, desc: 'Sends random Xxxtentacion wallpaper' , dontAddCommandList: true }, async (message, match) => {
