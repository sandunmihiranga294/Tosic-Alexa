...
const axios = require('axios');
  ...
  Asena.addCMD({pattern: 'love', fromMe: false,desc:' සමූහයක අයෙකුට ආදරේ ප්‍රකාශ කරන්න 🤗' }, (async (message, match) => {
...
Asena.addCMD({pattern: 'infolove', fromMe: false}, (async (message, match) => {
